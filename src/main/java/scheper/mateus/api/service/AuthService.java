...
import scheper.mateus.api.exception.LoginException;
...
public class AuthService {
    ...
    public String login(LoginRequest loginRequest) {
        ...
        User user = authRepository.findByEmailAndProvider(loginRequest.getEmail(), ProviderEnum.LOCAL)
                .orElseThrow(() -> new LoginException(errorMessage));
    ...
    public void register(RegisterUserRequest registerUserRequest) {
        ...
        userService.registerUser(registerUserRequest.getName().trim(), email, password, ProviderEnum.LOCAL, null);
    }
